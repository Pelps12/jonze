...
import { SignatureVerificationException, type EventResponse, type Event } from '@workos-inc/node';
import { deserializeEvent } from './deserializer';
export class Webhooks {
	...
	async computeSignature(timestamp: any, payload: any, secret: string): Promise<string> {
