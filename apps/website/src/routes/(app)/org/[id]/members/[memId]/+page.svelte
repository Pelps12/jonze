      ...
      {:then plans} 
        {#if $isDesktop}
          <Dialog.Root bind:open>
              ...
              <MembershipForm data={data.form} plans={plans}/>
        ...
        <div class="flex items-center justify-between space-x-4 relative">
            <div class="flex items- space-x-4">
                <div>
                    ...
                    <Button variant="link" class="text-sm text-muted-foreground p-0 m-0" href={`/org/${$page.params.id}/plans`}>{membership.plan.name}</Button>
                </div>
        ...
        <div class="flex items-center justify-between space-x-4 relative">
          <div class="flex items-center space-x-4">
              ...
              <div class="text-sm text-muted-foreground flex gap-1 items-center">
                <img src={`/payment_providers/${membership.provider.toLowerCase()}.svg`} alt="" class="w-6 h-6">
